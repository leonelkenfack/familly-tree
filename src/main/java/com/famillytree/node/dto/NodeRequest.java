...
import com.famillytree.node.model.NodeRelation.RelationType;
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request DTO for creating or updating a node")
public class NodeRequest {
    ...
    @Schema(description = "ID of the related node (if any)", example = "1")
    private Long relatedNodeId;

    @Schema(description = "Type of relation with the related node (if any)", example = "SIBLING")
